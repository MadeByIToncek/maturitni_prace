...
Pro dosažení požadované plynulosti využívám metodu~\textit{easeInOutQuad()}, která vstupní hodnotu $t$ přetranformuje na kubickou rovnici, jejíž rychlost (první derivace) představuje perfektní parabolu. %chktex 36
